...
void main() {
	...
	`}function iy(n){let e=new WeakMap,t=null;function i(o){if(o&&o.isTexture){const l=o.mapping,c=l===Il||l===Dl,u=l===Ls||l===Is;if(c||u){let f=e.get(o);const d=f!==void 0?f.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new od(n)),f=c?t.fromEquirectangular(o,f):t.fromCubemap(o,f),f.texture.pmremVersion=o.pmremVersion,e.set(o,f),f.texture;if(f!==void 0)return f.texture;{const h=o.image;return c&&h&&h.height>0||u&&h&&s(h)?(t===null&&(t=new od(n)),f=c?t.fromEquirectangular(o):t.fromCubemap(o),f.texture.pmremVersion=o.pmremVersion,e.set(o,f),o.addEventListener("dispose",r),f.texture):null}}}return o}function s(o){let l=0;const c=6;for(let u=0;u<c;u++)o[u]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:a}}function sy(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let s;switch(i){case"WEBGL_depth_texture":s=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=n.getExtension(i)}return e[i]=s,s}return{has:function(i){return t(i)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(i){const s=t(i);return s===null&&br("THREE.WebGLRenderer: "+i+" extension not supported."),s}}}function ry(n,e,t,i){const s={},r=new WeakMap;function a(f){const d=f.target;d.index!==null&&e.remove(d.index);for(const _ in d.attributes)e.remove(d.attributes[_]);d.removeEventListener("dispose",a),delete s[d.id];const h=r.get(d);h&&(e.remove(h),r.delete(d)),i.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(f,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function l(f){const d=f.attributes;for(const h in d)e.update(d[h],n.ARRAY_BUFFER)}function c(f){const d=[],h=f.index,_=f.attributes.position;let x=0;if(h!==null){const T=h.array;x=h.version;for(let A=0,S=T.length;A<S;A+=3){const I=T[A+0],R=T[A+1],P=T[A+2];d.push(I,R,R,P,P,I)}}else if(_!==void 0){const T=_.array;x=_.version;for(let A=0,S=T.length/3-1;A<S;A+=3){const I=A+0,R=A+1,P=A+2;d.push(I,R,R,P,P,I)}}else return;const m=new(Ap(d)?Pp:Rp)(d,1);m.version=x;const p=r.get(f);p&&e.remove(p),r.set(f,m)}function u(f){const d=r.get(f);if(d){const h=f.index;h!==null&&d.version<h.version&&c(f)}else c(f);return r.get(f)}return{get:o,update:l,getWireframeAttribute:u}}function ay(n,e,t){let i;function s(d){i=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,h){n.drawElements(i,h,r,d*a),t.update(h,i,1)}function c(d,h,_){_!==0&&(n.drawElementsInstanced(i,h,r,d*a,_),t.update(h,i,_))}function u(d,h,_){if(_===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(i,h,0,r,d,0,_);let m=0;for(let p=0;p<_;p++)m+=h[p];t.update(m,i,1)}function f(d,h,_,x){if(_===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/a,h[p],x[p]);else{m.multiDrawElementsInstancedWEBGL(i,h,0,r,d,0,x,0,_);let p=0;for(let T=0;T<_;T++)p+=h[T]*x[T];t.update(p,i,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=f}function oy(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(r,a,o){switch(t.calls++,a){case n.TRIANGLES:t.triangles+=o*(r/3);break;case n.LINES:t.lines+=o*(r/2);break;case n.LINE_STRIP:t.lines+=o*(r-1);break;case n.LINE_LOOP:t.lines+=o*r;break;case n.POINTS:t.points+=o*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:i}}function ly(n,e,t){const i=new WeakMap,s=new vt;function r(a,o,l){const c=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=u!==void 0?u.length:0;let d=i.get(o);if(d===void 0||d.count!==f){let y=function(){P.dispose(),i.delete(o),o.removeEventListener("dispose",y)};d!==void 0&&d.texture.dispose();const h=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,x=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],p=o.morphAttributes.normal||[],T=o.morphAttributes.color||[];let A=0;h===!0&&(A=1),_===!0&&(A=2),x===!0&&(A=3);let S=o.attributes.position.count*A,I=1;S>e.maxTextureSize&&(I=Math.ceil(S/e.maxTextureSize),S=e.maxTextureSize);const R=new Float32Array(S*I*4*f),P=new Tp(R,S,I,f);P.type=Xn,P.needsUpdate=!0;const z=A*4;for(let E=0;E<f;E++){const U=m[E],B=p[E],q=T[E],te=S*I*4*E;for(let ee=0;ee<U.count;ee++){const Z=ee*z;h===!0&&(s.fromBufferAttribute(U,ee),R[te+Z+0]=s.x,R[te+Z+1]=s.y,R[te+Z+2]=s.z,R[te+Z+3]=0),_===!0&&(s.fromBufferAttribute(B,ee),R[te+Z+4]=s.x,R[te+Z+5]=s.y,R[te+Z+6]=s.z,R[te+Z+7]=0),x===!0&&(s.fromBufferAttribute(q,ee),R[te+Z+8]=s.x,R[te+Z+9]=s.y,R[te+Z+10]=s.z,R[te+Z+11]=q.itemSize===4?s.w:1)}}d={count:f,texture:P,size:new rt(S,I)},i.set(o,d),o.addEventListener("dispose",y)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(n,"morphTexture",a.morphTexture,t);else{let h=0;for(let x=0;x<c.length;x++)h+=c[x];const _=o.morphTargetsRelative?1:1-h;l.getUniforms().setValue(n,"morphTargetBaseInfluence",_),l.getUniforms().setValue(n,"morphTargetInfluences",c)}l.getUniforms().setValue(n,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(n,"morphTargetsTextureSize",d.size)}return{update:r}}function cy(n,e,t,i){let s=new WeakMap;function r(l){const c=i.render.frame,u=l.geometry,f=e.get(l,u);if(s.get(f)!==c&&(e.update(f),s.set(f,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return f}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}const zp=new Nt,fd=new Fp(1,1),Hp=new Tp,kp=new Rv,Vp=new Dp,dd=[],hd=[],pd=new Float32Array(16),md=new Float32Array(9),gd=new Float32Array(4);function Os(n,e,t){const i=n[0];if(i<=0||i>0)return n;const s=e*t;let r=dd[s];if(r===void 0&&(r=new Float32Array(s),dd[s]=r),e!==0){i.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,n[a].toArray(r,o)}return r}function Et(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function bt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function io(n,e){let t=hd[e];t===void 0&&(t=new Int32Array(e),hd[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function uy(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function fy(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Et(t,e))return;n.uniform2fv(this.addr,e),bt(t,e)}}function dy(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Et(t,e))return;n.uniform3fv(this.addr,e),bt(t,e)}}function hy(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Et(t,e))return;n.uniform4fv(this.addr,e),bt(t,e)}}function py(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Et(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),bt(t,e)}else{if(Et(t,i))return;gd.set(i),n.uniformMatrix2fv(this.addr,!1,gd),bt(t,i)}}function my(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Et(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),bt(t,e)}else{if(Et(t,i))return;md.set(i),n.uniformMatrix3fv(this.addr,!1,md),bt(t,i)}}function gy(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(Et(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),bt(t,e)}else{if(Et(t,i))return;pd.set(i),n.uniformMatrix4fv(this.addr,!1,pd),bt(t,i)}}function _y(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function vy(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Et(t,e))return;n.uniform2iv(this.addr,e),bt(t,e)}}function xy(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Et(t,e))return;n.uniform3iv(this.addr,e),bt(t,e)}}function Sy(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Et(t,e))return;n.uniform4iv(this.addr,e),bt(t,e)}}function My(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function yy(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Et(t,e))return;n.uniform2uiv(this.addr,e),bt(t,e)}}function Ey(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Et(t,e))return;n.uniform3uiv(this.addr,e),bt(t,e)}}function by(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Et(t,e))return;n.uniform4uiv(this.addr,e),bt(t,e)}}function Ay(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s);let r;this.type===n.SAMPLER_2D_SHADOW?(fd.compareFunction=bp,r=fd):r=zp,t.setTexture2D(e||r,s)}function Ty(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture3D(e||kp,s)}function wy(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTextureCube(e||Vp,s)}function Cy(n,e,t){const i=this.cache,s=t.allocateTextureUnit();i[0]!==s&&(n.uniform1i(this.addr,s),i[0]=s),t.setTexture2DArray(e||Hp,s)}function Ry(n){switch(n){case 5126:return uy;case 35664:return fy;case 35665:return dy;case 35666:return hy;case 35674:return py;case 35675:return my;case 35676:return gy;case 5124:case 35670:return _y;case 35667:case 35671:return vy;case 35668:case 35672:return xy;case 35669:case 35673:return Sy;case 5125:return My;case 36294:return yy;case 36295:return Ey;case 36296:return by;case 35678:case 36198:case 36298:case 36306:case 35682:return Ay;case 35679:case 36299:case 36307:return Ty;case 35680:case 36300:case 36308:case 36293:return wy;case 36289:case 36303:case 36311:case 36292:return Cy}}function Py(n,e){n.uniform1fv(this.addr,e)}function Ly(n,e){const t=Os(e,this.size,2);n.uniform2fv(this.addr,t)}function Iy(n,e){const t=Os(e,this.size,3);n.uniform3fv(this.addr,t)}function Dy(n,e){const t=Os(e,this.size,4);n.uniform4fv(this.addr,t)}function Uy(n,e){const t=Os(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function Ny(n,e){const t=Os(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function Fy(n,e){const t=Os(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function Oy(n,e){n.uniform1iv(this.addr,e)}function By(n,e){n.uniform2iv(this.addr,e)}function zy(n,e){n.uniform3iv(this.addr,e)}function Hy(n,e){n.uniform4iv(this.addr,e)}function ky(n,e){n.uniform1uiv(this.addr,e)}function Vy(n,e){n.uniform2uiv(this.addr,e)}function Gy(n,e){n.uniform3uiv(this.addr,e)}function Wy(n,e){n.uniform4uiv(this.addr,e)}function Xy(n,e,t){const i=this.cache,s=e.length,r=io(t,s);Et(i,r)||(n.uniform1iv(this.addr,r),bt(i,r));for(let a=0;a!==s;++a)t.setTexture2D(e[a]||zp,r[a])}function qy(n,e,t){const i=this.cache,s=e.length,r=io(t,s);Et(i,r)||(n.uniform1iv(this.addr,r),bt(i,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||kp,r[a])}function Yy(n,e,t){const i=this.cache,s=e.length,r=io(t,s);Et(i,r)||(n.uniform1iv(this.addr,r),bt(i,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||Vp,r[a])}function Ky(n,e,t){const i=this.cache,s=e.length,r=io(t,s);Et(i,r)||(n.uniform1iv(this.addr,r),bt(i,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||Hp,r[a])}function jy(n){switch(n){case 5126:return Py;case 35664:return Ly;case 35665:return Iy;case 35666:return Dy;case 35674:return Uy;case 35675:return Ny;case 35676:return Fy;case 5124:case 35670:return Oy;case 35667:case 35671:return By;case 35668:case 35672:return zy;case 35669:case 35673:return Hy;case 5125:return ky;case 36294:return Vy;case 36295:return Gy;case 36296:return Wy;case 35678:case 36198:case 36298:case 36306:case 35682:return Xy;case 35679:case 36299:case 36307:return qy;case 35680:case 36300:case 36308:case 36293:return Yy;case 36289:case 36303:case 36311:case 36292:return Ky}}class Zy{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=Ry(t.type)}}class $y{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=jy(t.type)}}class Jy{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],i)}}}const il=/(\w+)(\])?(\[|\.)?/g;function _d(n,e){n.seq.push(e),n.map[e.id]=e}function Qy(n,e,t){const i=n.name,s=i.length;for(il.lastIndex=0;;){const r=il.exec(i),a=il.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){_d(t,c===void 0?new Zy(o,n,e):new $y(o,n,e));break}else{let f=t.map[o];f===void 0&&(f=new Jy(o),_d(t,f)),t=f}}}class ba{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){const r=e.getActiveUniform(t,s),a=e.getUniformLocation(t,r.name);Qy(r,a,this)}}setValue(e,t,i,s){const r=this.map[t];r!==void 0&&r.setValue(e,i,s)}setOptional(e,t,i){const s=t[i];s!==void 0&&this.setValue(e,i,s)}static upload(e,t,i,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=i[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const i=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&i.push(a)}return i}}function vd(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}const eE=37297;let tE=0;function nE(n,e){const t=n.split(`
`),i=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;i.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return i.join(`
`)}const xd=new We;function iE(n){Je._getMatrix(xd,Je.workingColorSpace,n);const e=`mat3( ${xd.elements.map(t=>t.toFixed(4))} )`;switch(Je.getTransfer(n)){case Fa:return[e,"LinearTransferOETF"];case ot:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function Sd(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=(n.getShaderInfoLog(e)||"").trim();if(i&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+nE(n.getShaderSource(e),o)}else return r}function sE(n,e){const t=iE(e);return[`vec4 ${n}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function rE(n,e){let t;switch(e){case nv:t="Linear";break;case iv:t="Reinhard";break;case sv:t="Cineon";break;case rv:t="ACESFilmic";break;case ov:t="AgX";break;case lv:t="Neutral";break;case av:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const pa=new j;function aE(){Je.getLuminanceCoefficients(pa);const n=pa.x.toFixed(4),e=pa.y.toFixed(4),t=pa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function oE(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",n.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Js).join(`
`)}function lE(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function cE(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let s=0;s<i;s++){const r=n.getActiveAttrib(e,s),a=r.name;let o=1;r.type===n.FLOAT_MAT2&&(o=2),r.type===n.FLOAT_MAT3&&(o=3),r.type===n.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:n.getAttribLocation(e,a),locationSize:o}}return t}function Js(n){return n!==""}function Md(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function yd(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const uE=/^[ \t]*#include +<([\w\d./]+)>/gm;function dc(n){return n.replace(uE,dE)}const fE=new Map;function dE(n,e){let t=qe[e];if(t===void 0){const i=fE.get(e);if(i!==void 0)t=qe[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return dc(t)}const hE=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ed(n){return n.replace(hE,pE)}function pE(n,e,t,i){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=i.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function bd(n){let e=`precision ${n.precision} float;
...
#define LOW_PRECISION`),e}function mE(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===hp?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===N0?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Hn&&(e="SHADOWMAP_TYPE_VSM"),e}function gE(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ls:case Is:e="ENVMAP_TYPE_CUBE";break;case to:e="ENVMAP_TYPE_CUBE_UV";break}return e}function _E(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Is:e="ENVMAP_MODE_REFRACTION";break}return e}function vE(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case pp:e="ENVMAP_BLENDING_MULTIPLY";break;case ev:e="ENVMAP_BLENDING_MIX";break;case tv:e="ENVMAP_BLENDING_ADD";break}return e}function xE(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:i,maxMip:t}}function SE(n,e,t,i){const s=n.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=mE(t),c=gE(t),u=_E(t),f=vE(t),d=xE(t),h=oE(t),_=lE(r),x=s.createProgram();let m,p,T=t.glslVersion?"#version "+t.glslVersion+`
...
`)+`
`+p);const A=T+m+a,S=T+p+o,I=vd(s,s.VERTEX_SHADER,A),R=vd(s,s.FRAGMENT_SHADER,S);s.attachShader(x,I),s.attachShader(x,R),t.index0AttributeName!==void 0?s.bindAttribLocation(x,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function P(U){if(n.debug.checkShaderErrors){const B=s.getProgramInfoLog(x)||"",q=s.getShaderInfoLog(I)||"",te=s.getShaderInfoLog(R)||"",ee=B.trim(),Z=q.trim(),oe=te.trim();let W=!0,me=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(W=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,I,R);else{const ve=Sd(s,I,"vertex"),Ae=Sd(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
`;function E(){if(o.children.filter(L=>L.type==="LineSegments").forEach(L=>{o.remove(L),L.geometry.dispose(),L.material.dispose()}),f.length<2)return;const w=[];for(let L=0;L<f.length;L++)f.map(($,V)=>({pos:$,idx:V,dist:f[L].distanceToSquared($)})).filter($=>$.idx!==L).sort(($,V)=>$.dist-V.dist).slice(0,Math.min(p,f.length-1)).forEach($=>{w.push(f[L],$.pos)});if(f.length>10)for(let L=0;L<3;L++){const D=Math.floor(Math.random()*f.length),$=Math.floor(Math.random()*f.length);D!==$&&w.push(f[D],f[$])}if(w.length>0){const L=new ni().setFromPoints(w),D=new Np({color:10234410,transparent:!0,opacity:.4});o.add(new Qv(L,D))}}let U=null;function B(){U=setTimeout(function L(){const D=Math.floor(Math.random()*e.length);t.value=e[D],s.value.style.display="block",setTimeout(()=>{s.value.style.display="none"},15e3),U=setTimeout(L,15e3*2)},15e3)}function q(){U&&(clearTimeout(U),U=null),s.value&&(s.value.style.display="none")}function te(N){const w=[...I].sort((Y,ie)=>Y.priority-ie.priority),L=I.reduce((Y,ie)=>Y+ie.images.length,0);let D=0,$=!1;function V(Y){if(Y>=w.length){setTimeout(()=>{E(),a.value=100,ve()},100);return}const ie=w[Y],fe=ie.images.map(M=>new URL(Object.assign({"../assets/images/detail/1/main.png":Zu,"../assets/images/detail/10/main.png":$u,"../assets/images/detail/11/main.png":Ju,"../assets/images/detail/12/main.png":Qu,"../assets/images/detail/13/main.png":ef,"../assets/images/detail/14/main.png":tf,"../assets/images/detail/15/main.png":nf,"../assets/images/detail/16/main.png":sf,"../assets/images/detail/17/main.png":rf,"../assets/images/detail/18/main.png":af,"../assets/images/detail/19/main.png":of,"../assets/images/detail/2/main.png":lf,"../assets/images/detail/20/main.png":cf,"../assets/images/detail/21/main.png":uf,"../assets/images/detail/22/main.png":ff,"../assets/images/detail/23/main.png":df,"../assets/images/detail/24/main.png":hf,"../assets/images/detail/25/main.png":pf,"../assets/images/detail/26/main.png":mf,"../assets/images/detail/27/main.png":gf,"../assets/images/detail/28/main.png":_f,"../assets/images/detail/29/main.png":vf,"../assets/images/detail/3/main.png":xf,"../assets/images/detail/30/main.png":Sf,"../assets/images/detail/4/main.png":Mf,"../assets/images/detail/5/main.png":yf,"../assets/images/detail/6/main.png":Ef,"../assets/images/detail/7/main.png":bf,"../assets/images/detail/8/main.png":Af,"../assets/images/detail/9/main.png":Tf})[`../assets/images/detail/${M.src}/main.png`],import.meta.url).href);N.loadBatch(fe,(M,v)=>{const F=Math.round((D+M)/L*100);a.value=Math.min(100,F)},M=>{D+=ie.images.length;const v=Math.round(D/L*100);a.value=Math.min(100,v),ie.images.forEach(F=>{const X=M.get(new URL(Object.assign({"../assets/images/detail/1/main.png":Zu,"../assets/images/detail/10/main.png":$u,"../assets/images/detail/11/main.png":Ju,"../assets/images/detail/12/main.png":Qu,"../assets/images/detail/13/main.png":ef,"../assets/images/detail/14/main.png":tf,"../assets/images/detail/15/main.png":nf,"../assets/images/detail/16/main.png":sf,"../assets/images/detail/17/main.png":rf,"../assets/images/detail/18/main.png":af,"../assets/images/detail/19/main.png":of,"../assets/images/detail/2/main.png":lf,"../assets/images/detail/20/main.png":cf,"../assets/images/detail/21/main.png":uf,"../assets/images/detail/22/main.png":ff,"../assets/images/detail/23/main.png":df,"../assets/images/detail/24/main.png":hf,"../assets/images/detail/25/main.png":pf,"../assets/images/detail/26/main.png":mf,"../assets/images/detail/27/main.png":gf,"../assets/images/detail/28/main.png":_f,"../assets/images/detail/29/main.png":vf,"../assets/images/detail/3/main.png":xf,"../assets/images/detail/30/main.png":Sf,"../assets/images/detail/4/main.png":Mf,"../assets/images/detail/5/main.png":yf,"../assets/images/detail/6/main.png":Ef,"../assets/images/detail/7/main.png":bf,"../assets/images/detail/8/main.png":Af,"../assets/images/detail/9/main.png":Tf})[`../assets/images/detail/${F.src}/main.png`],import.meta.url).href),re=new Fr(1,1),K=new ei({side:En,transparent:!0,uniforms:{texture1:{value:X},highlight:{value:!1}},vertexShader:z,fragmentShader:y}),_e=new Tn(re,K),ue=X.image?X.image.width/X.image.height:2;_e.scale.set(ue,1,1),_e.position.set(F.x,F.y,ie.z),_e.userData.url=F.url||F.src,o.add(_e),u.push(_e),f.push(_e.position.clone())}),Y===0&&!$&&($=!0,r.value&&(r.value.style.display="block")),f.length>5&&E(),V(Y+1)})}V(0)}let ee=null;const Z=new fx,oe=new rt;function W(){Z.setFromCamera(oe,l),Z.near=1,Z.far=10}function me(N){if(d)return;oe.x=N.clientX/window.innerWidth*2-1,oe.y=-(N.clientY/window.innerHeight)*2+1,W();const w=Z.intersectObjects(u);if(w.length>0){const L=w[0].object;ee!==L&&(ee&&ee.material&&ee.material.uniforms&&(ee.material.uniforms.highlight.value=!1),ee=L,ee.material&&ee.material.uniforms&&(ee.material.uniforms.highlight.value=!0),r.value.style.cursor="pointer")}else ee&&ee.material&&ee.material.uniforms&&(ee.material.uniforms.highlight.value=!1),ee=null,r.value.style.cursor="default"}function ve(){e.forEach(N=>{const w=document.createElement("link");w.rel="prefetch",w.as="video",w.href=N,document.head.appendChild(w)})}const Ae=Tt(!1);function Ne(N){if(d||a.value<100||s.value.style.display!="none"||!Ae.value)return;oe.x=N.clientX/window.innerWidth*2-1,oe.y=-(N.clientY/window.innerHeight)*2+1,W();const w=Z.intersectObjects(u);if(w.length>0){const D=w[0].object.userData.url;sessionStorage.setItem("cameraState",JSON.stringify({x:l.position.x,y:l.position.y,z:l.position.z})),i.push({path:`/detail/${D}`})}}function Ye(N){N.button===0&&(d=!0,h={x:N.clientX,y:N.clientY},r.value.style.cursor="grabbing")}function Ke(N){if(!d){me(N);return}const w=N.clientX-h.x,L=N.clientY-h.y;h={x:N.clientX,y:N.clientY},l.position.x=Math.max(R.x.min,Math.min(R.x.max,l.position.x-w*T)),l.position.y=Math.max(R.y.min,Math.min(R.y.max,l.position.y+L*T))}function Xe(){d&&(d=!1,r.value.style.cursor=ee?"pointer":"default")}function se(N){N.preventDefault(),l.position.z=Math.max(R.z.min,Math.min(R.z.max,l.position.z+N.deltaY*.01*A)),W()}function O(){!l||!c||(l.aspect=window.innerWidth/window.innerHeight,l.updateProjectionMatrix(),c.setSize(window.innerWidth,window.innerHeight))}function ne(){const N=r.value;if(!N)return;o=new Kv,o.background=new et(1118481),l=new an(60,window.innerWidth/window.innerHeight,.1,1e3);const w=sessionStorage.getItem("cameraState");if(w)try{const{x:D,y:$,z:V}=JSON.parse(w);l.position.set(D,$,V)}catch{l.position.set(0,.1,m[0]+1.5)}else l.position.set(0,.1,m[0]+1.5);c=new KE({antialias:!0,alpha:!0}),c.setClearColor(1118481,1),c.outputEncoding=void 0,c.setSize(window.innerWidth,window.innerHeight),N.appendChild(c.domElement);const L=new cx(16777215,2);o.add(L)}function ae(){!c||!o||!l||(_=requestAnimationFrame(ae),c.render(o,l))}const le=()=>{sessionStorage.removeItem("cameraState")};let Re=!0;Eh(()=>{Re||B()}),bh(()=>{Re=!1,q()});const C=Tt(!1);function g(){C.value=!0,ne(),requestAnimationFrame(ae);const N=new P;te(N),window.addEventListener("mousedown",Ye),window.addEventListener("mousemove",Ke),window.addEventListener("mouseup",Xe),window.addEventListener("wheel",se,{passive:!1}),window.addEventListener("resize",O),window.addEventListener("click",Ne),window.addEventListener("beforeunload",le)}return wr(()=>{}),Cr(()=>{_&&cancelAnimationFrame(_),c&&c.dispose(),u.forEach(w=>{w.geometry&&w.geometry.dispose(),w.material&&(w.material.uniforms&&w.material.uniforms.texture1.value&&w.material.uniforms.texture1.value.dispose(),w.material.dispose())}),(o?.children?.filter(w=>w.type==="LineSegments")||[]).forEach(w=>{w.geometry&&w.geometry.dispose(),w.material&&w.material.dispose()}),window.removeEventListener("mousedown",Ye),window.removeEventListener("mousemove",Ke),window.removeEventListener("mouseup",Xe),window.removeEventListener("wheel",se),window.removeEventListener("resize",O),window.removeEventListener("click",Ne),window.removeEventListener("beforeunload",le)}),(N,w)=>(Rn(),Es(Wt,null,[st("div",{class:"video-container",ref_key:"videoContainer",ref:s,style:{display:"none"}},[st("video",{src:t.value,autoplay:"",muted:"",loop:""},null,8,jE)],512),st("div",{ref_key:"threeContainer",ref:r,class:"three-container",style:{display:"none"}},null,512),ds(st("div",ZE,[st("img",{src:I0,alt:"",srcset:"",onLoad:g},null,32),st("div",$E,[a.value<100?(Rn(),Es("span",JE,tr(a.value+"%"),1)):(Rn(),Es("span",{key:1,class:"unfold-text",onClick:w[0]||(w[0]=L=>{Ae.value=!0,B()})},"UNFOLD"))])],512),[[hs,C.value&&!Ae.value]])],64))}}),t1=Gp(e1,[["__scopeId","data-v-4417ba27"]]),n1="/Intellectuals-Artificial-Criminals/assets/bg-DiBbnZBS.png",i1="/Intellectuals-Artificial-Criminals/assets/bg-ByPUWdPk.png",s1="/Intellectuals-Artificial-Criminals/assets/bg-CuyevdZS.png",r1="/Intellectuals-Artificial-Criminals/assets/bg-CRMNdl4_.png",a1="/Intellectuals-Artificial-Criminals/assets/bg-CLdOmBO7.png",o1="/Intellectuals-Artificial-Criminals/assets/bg-xvTg2c41.png",l1="/Intellectuals-Artificial-Criminals/assets/bg-DJcfE9wX.png",c1="/Intellectuals-Artificial-Criminals/assets/bg-BtpcxYWu.png",u1="/Intellectuals-Artificial-Criminals/assets/bg-BiPUD9Ij.png",f1="/Intellectuals-Artificial-Criminals/assets/bg-Cq4_pmJP.png",d1="/Intellectuals-Artificial-Criminals/assets/bg-DeKnG647.png",h1="/Intellectuals-Artificial-Criminals/assets/bg-C7nkN8Qu.png",p1="/Intellectuals-Artificial-Criminals/assets/bg-D9tj_Tzb.png",m1="/Intellectuals-Artificial-Criminals/assets/bg-Bv1KCed0.png",g1="/Intellectuals-Artificial-Criminals/assets/bg-Bk3I5BVa.png",_1="/Intellectuals-Artificial-Criminals/assets/bg-CpAP5bqW.png",v1="/Intellectuals-Artificial-Criminals/assets/bg-CNK2s0bx.png",x1="/Intellectuals-Artificial-Criminals/assets/bg-Dz1oS1eA.png",S1="/Intellectuals-Artificial-Criminals/assets/bg-CC9SqGaw.png",M1="/Intellectuals-Artificial-Criminals/assets/bg-CGAslaDo.png",y1="/Intellectuals-Artificial-Criminals/assets/bg-EWl2rd8g.png",E1="/Intellectuals-Artificial-Criminals/assets/bg-B_V-Uc7b.png",b1="/Intellectuals-Artificial-Criminals/assets/bg-DGt3nX07.png",A1="/Intellectuals-Artificial-Criminals/assets/bg-BWj7D3eH.png",T1="/Intellectuals-Artificial-Criminals/assets/bg-Cb6lx4GF.png",w1="/Intellectuals-Artificial-Criminals/assets/bg-DNSU5FVq.png",C1="/Intellectuals-Artificial-Criminals/assets/bg-BTbn9Mgc.png",R1="/Intellectuals-Artificial-Criminals/assets/bg-3
="/Intellectuals-Artificial-Criminals/assets/enlarge-BsQQgiOk.png",vb="/Intellectuals-Artificial-Criminals/assets/enlarge-fL8LzinN.png",xb="/Intellectuals-Artificial-Criminals/assets/enlarge-30YN1zVL.png",Sb="/Intellectuals-Artificial-Criminals/assets/enlarge-CIe_lLQP.png",Mb="/Intellectuals-Artificial-Criminals/assets/enlarge-BfEtsxOZ.png",yb="/Intellectuals-Artificial-Criminals/assets/enlarge-CLzDwCpd.png",Eb="/Intellectuals-Artificial-Criminals/assets/enlarge-D8uUQUA3.png",bb="/Intellectuals-Artificial-Criminals/assets/enlarge-Dp5-9cKY.png",Ab="/Intellectuals-Artificial-Criminals/assets/enlarge-akkndy-O.png",Tb="/Intellectuals-Artificial-Criminals/assets/enlarge-DxuONywL.png",wb="/Intellectuals-Artificial-Criminals/assets/enlarge-C6dd3WYx.png",Cb="/Intellectuals-Artificial-Criminals/assets/enlarge-DK-yT6yd.png",Rb="/Intellectuals-Artificial-Criminals/assets/enlarge-BIEX0-Ud.png",Pb="/Intellectuals-Artificial-Criminals/assets/enlarge-BjbhSNQH.png",Lb="/Intellectuals-Artificial-Criminals/assets/enlarge-D_-QMuyG.png",Ib="/Intellectuals-Artificial-Criminals/assets/enlarge-NWO2RnKL.png",Db="/Intellectuals-Artificial-Criminals/assets/enlarge-lvoqWaK_.png",Ub="/Intellectuals-Artificial-Criminals/assets/enlarge-DbREQIin.png",Nb="/Intellectuals-Artificial-Criminals/assets/enlarge-4Icmoj8N.png",Fb="/Intellectuals-Artificial-Criminals/assets/enlarge-BuqkthQh.png",Ob="/Intellectuals-Artificial-Criminals/assets/enlarge-ByxnEF-o.png",Bb="data:image/png;base64,",zb="data:image/png;base64,",Hb="data:image/png;base64,";function Bs(n,e){e===void 0&&(e={});var t=e.insertAt;if(n&&typeof document<"u"){var i=document.head||document.getElementsByTagName("head")[0],s=document.createElement("style");s.type="text/css",t==="top"&&i.firstChild?i.insertBefore(s,i.firstChild):i.appendChild(s),s.styleSheet?s.styleSheet.cssText=n:s.appendChild(document.createTextNode(n))}}Bs(".vel-fade-enter-active,.vel-fade-leave-active{-webkit-transition:all .3s ease;transition:all .3s ease}.vel-fade-enter-from,.vel-fade-leave-to{opacity:0}.vel-img-swiper{display:block;position:relative}.vel-modal{background:rgba(0,0,0,.5);bottom:0;left:0;margin:0;position:fixed;right:0;top:0;z-index:9998}.vel-img-wrapper{left:50%;margin:0;position:absolute;top:50%;-webkit-transform:translate(-50% -50%);transform:translate(-50% -50%);-webkit-transition:.3s linear;transition:.3s linear;will-change:transform opacity}.vel-img,.vel-img-wrapper{-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.vel-img{background-color:rgba(0,0,0,.7);-webkit-box-shadow:0 5px 20px 2px rgba(0,0,0,.7);box-shadow:0 5px 20px 2px rgba(0,0,0,.7);display:block;max-height:80vh;max-width:80vw;position:relative;-webkit-transition:-webkit-transform .3s ease-in-out;transition:-webkit-transform .3s ease-in-out;transition:transform .3s ease-in-out;transition:transform .3s ease-in-out,-webkit-transform .3s ease-in-out}@media (max-width:750px){.vel-img{max-height:95vh;max-width:85vw}}.vel-btns-wrapper{position:static}.vel-btns-wrapper .btn__close,.vel-btns-wrapper .btn__next,.vel-btns-wrapper .btn__prev{-webkit-tap-highlight-color:transparent;color:#fff;cursor:pointer;font-size:32px;opacity:.6;outline:none;position:absolute;top:50%;-webkit-transform:translateY(-50%);transform:translateY(-50%);-webkit-transition:.15s linear;transition:.15s linear;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.vel-btns-wrapper .btn__close:hover,.vel-btns-wrapper .btn__next:hover,.vel-btns-wrapper .btn__prev:hover{opacity:1}.vel-btns-wrapper .btn__close.disable,.vel-btns-wrapper .btn__close.disable:hover,.vel-btns-wrapper .btn__next.disable,.vel-btns-wrapper .btn__next.disable:hover,.vel-btns-wrapper .btn__prev.disable,.vel-btns-wrapper .btn__prev.disable:hover{cursor:default;opacity:.2}.vel-btns-wrapper .btn__next{right:12px}.vel-btns-wrapper .btn__prev{left:12px}.vel-btns-wrapper .btn__close{right:10px;top:24px}@media (max-width:750px){.vel-btns-wrapper .btn__next,.vel-btns-wrapper .btn__prev{font-size:20px}.vel-btns-wrapper .btn__close{font-size:24px}.vel-btns-wrapper .btn__next{right:4px}.vel-btns-wrapper .btn__prev{left:4px}}.vel-modal.is-rtl .vel-btns-wrapper .btn__next{left:12px;right:auto}.vel-modal.is-rtl .vel-btns-wrapper .btn__prev{left:auto;right:12px}@media (max-width:750px){.vel-modal.is-rtl .vel-btns-wrapper .btn__next{left:4px;right:auto}.vel-modal.is-rtl .vel-btns-wrapper .btn__prev{left:auto;right:4px}}.vel-modal.is-rtl .vel-img-title{direction:rtl}");Bs('.vel-loading{left:50%;position:absolute;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}.vel-loading .ring{display:inline-block;height:64px;width:64px}.vel-loading .ring:after{-webkit-animation:ring 1.2s linear infinite;animation:ring 1.2s linear infinite;border-color:hsla(0,0%,100%,.7) transparent;border-radius:50%;border-style:solid;border-width:5px;content:" ";display:block;height:46px;margin:1px;width:46px}@-webkit-keyframes ring{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}@keyframes ring{0%{-webkit-transform:rotate(0deg);transform:rotate(0deg)}to{-webkit-transform:rotate(1turn);transform:rotate(1turn)}}');Bs(".vel-on-error{left:50%;position:absolute;top:50%;-webkit-transform:translate(-50%,-50%);transform:translate(-50%,-50%)}.vel-on-error .icon{color:#aaa;font-size:80px}");Bs(".vel-img-title{bottom:60px;color:#ccc;cursor:default;font-size:12px;left:50%;line-height:1;max-width:80%;opacity:.8;overflow:hidden;position:absolute;text-align:center;text-overflow:ellipsis;-webkit-transform:translate(-50%);transform:translate(-50%);-webkit-transition:opacity .15s;transition:opacity .15s;white-space:nowrap}.vel-img-title:hover{opacity:1}");Bs(".vel-icon{fill:currentColor;height:1em;overflow:hidden;vertical-align:-.15em;width:1em}");Bs(".vel-toolbar{border-radius:4px;bottom:8px;display:-webkit-box;display:-ms-flexbox;display:flex;left:50%;opacity:.9;overflow:hidden;padding:0;position:absolute;-webkit-transform:translate(-50%);transform:translate(-50%)}.vel-toolbar,.vel-toolbar .toolbar-btn{background-color:#2d2d2d;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.vel-toolbar .toolbar-btn{-ms-flex-negative:0;-webkit-tap-highlight-color:transparent;color:#fff;cursor:pointer;flex-shrink:0;font-size:20px;outline:none;padding:6px 10px}.vel-toolbar .toolbar-btn:active,.vel-toolbar .toolbar-btn:hover{background-color:#3d3d3d}");const rn="vel",hn=Ns({name:"SvgIcon",props:{type:{type:String,default:""}},setup:n=>()=>Me("svg",{class:`${rn}-icon icon`,"aria-hidden":"true"},[Me("use",{"xlink:href":`#icon-${n.type}`},null)])}),so=typeof window<"u",ms=()=>{};let Wp=!1;if(so)try{const n={};Object.defineProperty(n,"passive",{get(){Wp=!0}}),window.addEventListener("test-passive",ms,n)}catch{}const Cd=function(n,e,t){let i=arguments.length>3&&arguments[3]!==void 0&&arguments[3];so&&n.addEventListener(e,t,!!Wp&&{capture:!1,passive:i})},Rd=(n,e,t)=>{so&&n.removeEventListener(e,t)},kb=n=>{n.preventDefault()},Vb=Object.prototype.toString,Wc=n=>e=>Vb.call(e).slice(8,-1)===n,Gb=n=>!!n&&Wc("Object")(n),Pd=n=>!!n&&Wc("String")(n);function Wb(n){return n!=null}const Xb=Ns({name:"Toolbar",props:{zoomIn:{type:Function,default:ms},zoomOut:{type:Function,default:ms},rotateLeft:{type:Function,default:ms},rotateRight:{type:Function,default:ms},resize:{type:Function,default:ms},rotateDisabled:{type:Boolean,default:!1},zoomDisabled:{type:Boolean,default:!1}},setup:n=>()=>Me("div",{class:`${rn}-toolbar`},[!n.zoomDisabled&&Me(Wt,null,[Me("div",{role:"button","aria-label":"zoom in button",class:"toolbar-btn toolbar-btn__zoomin",onClick:n.zoomIn},[Me(hn,{type:"zoomin"},null)]),Me("div",{role:"button","aria-label":"zoom out button",class:"toolbar-btn toolbar-btn__zoomout",onClick:n.zoomOut},[Me(hn,{type:"zoomout"},null)])]),Me("div",{role:"button","aria-label":"resize image button",class:"toolbar-btn toolbar-btn__resize",onClick:n.resize},[Me(hn,{type:"resize"},null)]),!n.rotateDisabled&&Me(Wt,null,[Me("div",{role:"button","aria-label":"image rotate left button",class:"toolbar-btn toolbar-btn__rotate",onClick:n.rotateLeft},[Me(hn,{type:"rotate-left"},null)]),Me("div",{role:"button","aria-label":"image rotate right button",class:"toolbar-btn toolbar-btn__rotate",onClick:n.rotateRight},[Me(hn,{type:"rotate-right"},null)])])])}),qb=()=>Me("div",{class:`${rn}-loading`},[Me("div",{class:"ring"},null)]),Yb=()=>Me("div",{class:`${rn}-on-error`},[Me("div",{class:"ring"},null),Me(hn,{type:"img-broken"},null)]),Kb=(n,e)=>{let{slots:t}=e;return Me("div",{class:`${rn}-img-title`},[t.default?t.default():""])},jb=Ns({name:"DefaultIcons",setup:()=>()=>Me("svg",{"aria-hidden":!0,style:"position: absolute; width: 0; height: 0; overflow: hidden; visibility: hidden;"},[Me("symbol",{id:"icon-rotate-right",viewBox:"0 0 1024 1024"},[Me("path",{d:"M275.199914 450.496179v20.031994c0.384-38.079988 12.543996-67.423979 36.479989-87.967973 22.431993-20.351994 49.215985-30.55999 80.319975-30.55999 32.06399 0 59.295981 10.175997 81.759974 30.55999 22.815993 20.543994 34.591989 49.887984 35.359989 87.967973v123.935961c-0.768 37.887988-12.543996 67.135979-35.359989 87.679973-22.431993 20.351994-49.695984 30.75199-81.759974 31.10399a120.255962 120.255962 0 0 1-72.991978-24.895992c-21.503993-15.839995-35.359989-38.751988-41.567987-68.735979h60.831981c9
 286.208-126.912 286.208-282.624 286.208z"},null),Me("path",{d:"M235.712 369.92h390.72v127.104H235.712z"},null),Me("path",{d:"M367.488 238.144h127.104v390.72H367.488z"},null)]),Me("symbol",{id:"icon-close",viewBox:"0 0 1024 1024"},[Me("path",{d:"M570.24 512l259.2 259.2-58.88 58.24L512 570.24l-261.12 261.12-58.24-58.24L453.76 512 194.56 252.8l58.24-58.24L512 453.76l261.12-261.12 58.24 58.24z"},null)]),Me("symbol",{id:"icon-zoomout",viewBox:"0 0 1024 1024"},[Me("path",{d:"M725.504 652.864c46.4-61.44 71.744-136.448 71.744-218.752C797.248 230.464 632.768 64 430.656 64S64 230.464 64 434.112C64 639.36 228.48 805.76 430.656 805.76c86.656 0 164.48-30.144 227.52-81.088L889.984 960 960 891.264l-234.496-238.4z m-294.848 67.456c-155.776 0-282.624-128.896-282.624-286.208s126.848-286.208 282.624-286.208 282.624 128.896 282.624 286.208-126.912 286.208-282.624 286.208z"},null),Me("path",{d:"M235.712 369.92h390.72v127.104H235.712z"},null)])])}),ur=so?window:global;let Ld=Date.now();function Zb(n){const e=Date.now(),t=Math.max(0,16-(e-Ld)),i=setTimeout(n,t);return Ld=e+t,i}function sl(n){return(ur.requestAnimationFrame||Zb).call(ur,n)}function Id(n){(ur.cancelAnimationFrame||ur.clearTimeout).call(ur,n)}function Dd(n,e){const t=n.clientX-e.clientX,i=n.clientY-e.clientY;return Math.sqrt(t*t+i*i)}function rl(n){return typeof n=="function"||Object.prototype.toString.call(n)==="[object Object]"&&!ws(n)}var al=Ns({name:"VueEasyLightbox",props:{imgs:{type:[Array,String],default:()=>""},visible:{type:Boolean,default:!1},index:{type:Number,default:0},scrollDisabled:{type:Boolean,default:!0},escDisabled:{type:Boolean,default:!1},moveDisabled:{type:Boolean,default:!1},titleDisabled:{type:Boolean,default:!1},maskClosable:{type:Boolean,default:!0},teleport:{type:[String,Object],default:null},swipeTolerance:{type:Number,default:50},loop:{type:Boolean,default:!1},rtl:{type:Boolean,default:!1},zoomScale:{type:Number,default:.12},maxZoom:{type:Number,default:3},minZoom:{type:Number,default:.1},rotateDisabled:{type:Boolean,default:!1},zoomDisabled:{type:Boolean,default:!1},pinchDisabled:{type:Boolean,default:!1},dblclickDisabled:{type:Boolean,default:!1}},emits:{hide:()=>!0,"on-error":n=>!0,"on-prev":(n,e)=>!0,"on-next":(n,e)=>!0,"on-prev-click":(n,e)=>!0,"on-next-click":(n,e)=>!0,"on-index-change":(n,e)=>!0,"on-rotate":n=>!0},setup(n,e){let{emit:t,slots:i}=e;const{imgRef:s,imgState:r,setImgSize:a}=(()=>{const w=Tt(),L=Wi({width:0,height:0,maxScale:1});return{imgRef:w,imgState:L,setImgSize:()=>{if(w.value){const{width:D,height:$,naturalWidth:V}=w.value;L.maxScale=V/D,L.width=D,L.height=$}}}})(),o=Tt(n.index),l=Tt(""),c=Wi({scale:1,lastScale:1,rotateDeg:0,top:0,left:0,initX:0,initY:0,lastX:0,lastY:0,touches:[]}),u=Wi({loadError:!1,loading:!1,dragging:!1,gesturing:!1,wheeling:!1}),f=yt((()=>{return w=n.imgs,Wc("Array")(w)?n.imgs.map((L=>typeof L=="string"?{src:L}:(function(D){return Gb(D)&&Pd(D.src)})(L)?L:void 0)).filter(Wb):Pd(n.imgs)?[{src:n.imgs}]:[];var w})),d=yt((()=>f.value[o.value])),h=yt((()=>f.value[o.value]?.src)),_=yt((()=>f.value[o.value]?.title)),x=yt((()=>f.value[o.value]?.alt)),m=yt((()=>({cursor:u.loadError?"default":n.moveDisabled?u.dragging?"grabbing":"grab":"move",top:`calc(50% + ${c.top}px)`,left:`calc(50% + ${c.left}px)`,transition:u.dragging||u.gesturing?"none":"",transform:`translate(-50%, -50%) scale(${c.scale}) rotate(${c.rotateDeg}deg)`}))),p=()=>{t("hide")},T=()=>{c.scale=1,c.lastScale=1,c.rotateDeg=0,c.top=0,c.left=0,u.loadError=!1,u.dragging=!1,u.loading=!0},A=(w,L)=>{const D=o.value;T(),o.value=w,f.value[o.value]===f.value[w]&&Xi((()=>{u.loading=!1})),n.visible&&D!==w&&(L&&L(D,w),t("on-index-change",D,w))},S=()=>{const w=o.value,L=n.loop?(w+1)%f.value.length:w+1;!n.loop&&L>f.value.length-1||A(L,((D,$)=>{t("on-next",D,$),t("on-next-click",D,$)}))},I=()=>{const w=o.value;let L=w-1;if(w===0){if(!n.loop)return;L=f.value.length-1}A(L,((D,$)=>{t("on-prev",D,$),t("on-prev-click",D,$)}))},R=w=>{Math.abs(1-w)<.05?w=1:Math.abs(r.maxScale-w)<.05&&(w=r.maxScale),c.lastScale=c.scale,c.scale=w},P=()=>{const w=c.scale+n.zoomScale;w<r.maxScale*n.maxZoom&&R(w)},z=()=>{const w=c.scale-n.zoomScale;w>n.minZoom&&R(w)},y=()=>{const w=c.rotateDeg%360;t("on-rotate",Math.abs(w<0?w+360:w))},E=()=>{c.rotateDeg-=90,y()},U=()=>{c.rotateDeg+=90,y()},B=()=>{c.scale=1,c.top=0,c.left=0},q=function(){let w=arguments.length>0&&arguments[0]!==void 0?arguments[0]:0;return!n.moveDisabled&&w===0},{onMouseDown:te,onMouseMove:ee,onMouseUp:Z}=((w,L,D)=>{let $,V=!1;return{onMouseDown:Y=>{w.initX=w.lastX=Y.clientX,w.initY=w.lastY=Y.clientY,L.dragging=!0,V=!1,Y.stopPropagation()},onMouseUp:Y=>{D(Y.button)&&Id($),L.dragging=!1,V=!1},onMouseMove:Y=>{if(L.dragging)if(D(Y.button)){if(V)return;V=!0,$=sl((()=>{const{top:ie,left:fe,lastY:M,lastX:v}=w;w.top=ie-M+Y.clientY,w.left=fe-v+Y.clientX,w.lastX=Y.clientX,w.lastY=Y.clientY,V=!1}))}else w.lastX=Y.clientX,w.lastY=Y.clientY;Y.stopPropagation()}}})(c,u,q),{onTouchStart:oe,onTouchMove:W,onTouchEnd:me}=((w,L,D,$,V)=>{let Y,ie=!1;return{onTouchStart:fe=>{const{touches:M}=fe;M.length>1&&V()?(D.gesturing=!0,L.touches=M):(L.initX=L.lastX=M[0].clientX,L.initY=L.lastY=M[0].clientY,D.dragging=!0),fe.stopPropagation()},onTouchMove:fe=>{if(ie)return;const{touches:M}=fe,{lastX:v,lastY:F,left:X,top:re,scale:K}=L;if(!D.gesturing&&D.dragging){if(!M[0])return;const{clientX:_e,clientY:ue}=M[0];$()?Y=sl((()=>{L.lastX=_e,L.lastY=ue,L.top=re-F+ue,L.left=X-v+_e,ie=!1})):(L.lastX=_e,L.lastY=ue)}else D.gesturing&&L.touches.length>1&&M.length>1&&V()&&(Y=sl((()=>{const _e=(Dd(L.touches[0],L.touches[1])-Dd(M[0],M[1]))/w.width;L.touches=M;const ue=K-1.3*_e;ue>.5&&ue<1.5*w.maxScale&&(L.scale=ue),ie=!1})))},onTouchEnd:()=>{Id(Y),D.dragging=!1,D.gesturing=!1,ie=!1}}})(r,c,u,q,(()=>!n.pinchDisabled)),ve=()=>{n.dblclickDisabled||(c.scale!==r.maxScale?(c.lastScale=c.scale,c.scale=r.maxScale):c.scale=c.lastScale)},Ae=w=>{u.loadError||u.gesturing||u.loading||u.dragging||u.wheeling||!n.scrollDisabled||n.zoomDisabled||(u.wheeling=!0,setTimeout((()=>{u.wheeling=!1}),80),w.deltaY<0?P():z())},Ne=w=>{const L=w;n.visible&&(!n.escDisabled&&L.key==="Escape"&&n.visible&&p(),L.key==="ArrowLeft"&&(n.rtl?S():I()),L.key==="ArrowRight"&&(n.rtl?I():S()))},Ye=()=>{n.maskClosable&&p()},Ke=()=>{a()},Xe=()=>{u.loading=!1},se=w=>{u.loading=!1,u.loadError=!0,t("on-error",w)},O=()=>{n.visible&&a()};_i((()=>n.index),(w=>{w<0||w>=f.value.length||A(w)})),_i((()=>u.dragging),((w,L)=>{const D=!w&&L;if(!q()&&D){const $=c.lastX-c.initX,V=c.lastY-c.initY,Y=n.swipeTolerance;Math.abs($)>Math.abs(V)&&($<-1*Y?S():$>Y&&I())}})),_i((()=>n.visible),(w=>{if(w){T();const L=f.value.length;if(L===0)return o.value=0,u.loading=!1,void Xi((()=>u.loadError=!0));o.value=n.index>=L?L-1:n.index<0?0:n.index,n.scrollDisabled&&ne()}else n.scrollDisabled&&ae()}));const ne=()=>{document&&(l.value=document.body.style.overflowY,document.body.style.overflowY="hidden")},ae=()=>{document&&(document.body.style.overflowY=l.value)};wr((()=>{Cd(document,"keydown",Ne),Cd(window,"resize",O)})),Cr((()=>{Rd(document,"keydown",Ne),Rd(window,"resize",O),n.scrollDisabled&&ae()}));const le=()=>u.loading?i.loading?i.loading({key:"loading"}):Me(qb,{key:"img-loading"},null):u.loadError?i.onerror?i.onerror({key:"onerror"}):Me(Yb,{key:"img-on-error"},null):Me("div",{class:`${rn}-img-wrapper`,style:m.value,key:"img-wrapper"},[Me("img",{alt:x.value,ref:s,draggable:"false",class:`${rn}-img`,src:h.value,onMousedown:te,onMouseup:Z,onMousemove:ee,onTouchstart:oe,onTouchmove:W,onTouchend:me,onLoad:Ke,onDblclick:ve,onDragstart:w=>{w.preventDefault()}},null)]),Re=()=>{if(i["prev-btn"])return i["prev-btn"]({prev:I});if(f.value.length<=1)return;const w=!n.loop&&o.value<=0;return Me("div",{role:"button","aria-label":"previous image button",class:"btn__prev "+(w?"disable":""),onClick:I},[n.rtl?Me(hn,{type:"next"},null):Me(hn,{type:"prev"},null)])},C=()=>{if(i["next-btn"])return i["next-btn"]({next:S});if(f.value.length<=1)return;const w=!n.loop&&o.value>=f.value.length-1;return Me("div",{role:"button","aria-label":"next image button",class:"btn__next "+(w?"disable":""),onClick:S},[n.rtl?Me(hn,{type:"prev"},null):Me(hn,{type:"next"},null)])},g=()=>{if(!(n.titleDisabled||u.loading||u.loadError))return i.title?i.title({currentImg:d.value}):_.value?Me(Kb,null,{default:()=>[_.value]}):void 0},N=()=>{let w;if(n.visible)return Me("div",{onTouchmove:kb,class:[`${rn}-modal`,n.rtl?"is-rtl":""],onClick:S_(Ye,["self"]),onWheel:Ae},[Me(jb,null,null),Me(vo,{name:`${rn}-fade`,mode:"out-in"},rl(w=le())?w:{default:()=>[w]}),Me("img",{style:"display:none;",src:h.value,onError:se,onLoad:Xe},null),Me("div",{class:`${rn}-btns-wrapper`},[Re(),C(),g(),i["close-btn"]?i["close-btn"]({close:p}):Me("div",{role:"button","aria-label":"close image preview button",class:"btn__close",onClick:p},[Me(hn,{type:"close"},null)]),i.toolbar?i.toolbar({toolbarMethods:{zoomIn:P,zoomOut:z,rotate:E,rotateLeft:E,rotateRight:U,resize:B},zoomIn:P,zoomOut:z,rotate:E,rotateLeft:E,rotateRight:U,resize:B}):Me(Xb,{zoomIn:P,zoomOut:z,resize:B,rotateLeft:E,rotateRight:U,rotateDisabled:n.rotateDisabled,zoomDisabled:n.zoomDisabled},null)])])};return()=>{let w;if(n.teleport){let L;return Me(Vm,{to:n.teleport},{default:()=>[Me(vo,{name:`${rn}-fade`},rl(L=N())?L:{default:()=>[L]})]})}return Me(vo,{name:`${rn}-fade`},rl(w=N())?w:{default:()=>[w]})}}});const $b=Object.assign(al,{install:n=>{n.component(al.name,al)}}),Jb={key:0,class:"detail-container"},Qb=["src"],eA={class:"bg-ele"},tA=["src"],nA={class:"chat-list"},iA={class:"chat-list-title"},sA={class:"chat-list-content"},rA={class:"chat-box"},aA={class:"chat-bg"},oA={class:"chat-content"},lA=["src"],cA=["src"],uA={name:"DetailPage"},fA=Object.assign(uA,{props:{id:String},setup(n){const e=n,t=dp(),i=Tt(!0),s=()=>{t.currentRoute.value.name==="DetailPage"&&(window.history.replaceState({},"","/"),Xi(()=>{t.back()})),t.replace({name:"HomePage"})},r=Tt(!1),a=Tt(!1),o=Tt(!1),l=()=>new URL(Object.assign({"../assets/images/detail/1/bg.png":n1,"../assets/images/detail/10/bg.png":i1,"../assets/images/detail/11/bg.png":s1,"../assets/images/detail/12/bg.png":r1,"../assets/images/detail/13/bg.png":a1,"../assets/images/detail/14/bg.png":o1,"../assets/images/detail/15/bg.png":l1,"../assets/images/detail/16/bg.png":c1,"../assets/images/detail/17/bg.png":u1,"../assets/images/detail/18/bg.png":f1,"../assets/images/detail/19/bg.png":d1,"../assets/images/detail/2/bg.png":h1,"../assets/images/detail/20/bg.png":
:"fixed",top:0,left:0,width:"100vw",height:"100vh",backgroundImage:`url(${u()})`,backgroundSize:"cover",backgroundPosition:"center",zIndex:998})),d=()=>{r.value=!0},h=Tt(null),_=Tt(!1),x=()=>{_.value=!_.value,_.value&&Xi(()=>{h.value?.focus()})},m=Tt(!1),p=yt(()=>_.value?new URL("data:image/png;base64,",import.meta.url).href:m.value?new URL("data:image/png;base64,",import.meta.url).href:new URL("data:image/png;base64,",import.meta.url).href);function T(){const P="abcdefghijklmnopqrstuvwxyz0123456789";let z="";for(let y=0;y<6;y++)z+=P.charAt(Math.floor(Math.random()*P.length));return"h1*"+z}const A=T(),S=Tt([]),I=()=>{const R=h.value.value.trim();R&&S.value.push(R),h.value.value="",Xi(()=>{const P=document.querySelector(".chat-list");P&&(P.scrollTop=P.scrollHeight)})};return(R,P)=>i.value?(Rn(),Es("div",Jb,[ds(st("div",{class:Xa(["text-ele cursor",{animate:a.value}]),onClick:d},[st("img",{src:c(),alt:"btn",onLoad:P[0]||(P[0]=()=>{o.value=!0,a.value=!0})},null,40,Qb)],2),[[hs,o.value]]),st("div",eA,[st("img",{src:l(),alt:"detail-bg"},null,8,tA)]),st("div",nA,[(Rn(!0),Es(Wt,null,ig(S.value,(z,y)=>(Rn(),Es("div",{key:y,class:"chat-item"},[st("div",iA,tr(qn(A)),1),st("div",sA,tr(z),1)]))),128))]),st("div",rA,[ds(st("div",{class:"chat-title"},tr(qn(A)),513),[[hs,_.value]]),ds(st("div",aA,[...P[4]||(P[4]=[st("img",{src:Bb,alt:"chat-bg"},null,-1)])],512),[[hs,_.value]]),ds(st("div",oA,[st("textarea",{ref_key:"chatTextarea",ref:h,placeholder:"",onKeyup:y_(I,["enter"])},null,544)],512),[[hs,_.value]]),st("div",{class:"chat-status cursor",onClick:x},[st("img",{src:p.value,alt:"chat-status",onMouseover:P[1]||(P[1]=z=>m.value=!0),onMouseleave:P[2]||(P[2]=z=>m.value=!1)},null,40,lA)]),P[5]||(P[5]=st("div",{class:"chat-dot"},[st("img",{src:zb,alt:"chat-dot"})],-1))]),st("div",{class:"cursor back-btn",onClick:s},[...P[6]||(P[6]=[st("img",{src:Hb,alt:"返回"},null,-1)])]),ds(st("div",{style:Wa(f.value)},null,4),[[hs,r.value]]),st("img",{src:u(),style:{display:"none"},alt:"preload"},null,8,cA),Me(qn($b),{visible:r.value,imgs:[c()],onHide:P[3]||(P[3]=z=>r.value=!1)},null,8,["visible","imgs"])])):Og("",!0)}}),dA=Gp(fA,[["__scopeId","data-v-c8e390b4"]]),hA=[{path:"/",name:"HomePage",component:t1},{path:"/detail/:id([^/]+)",name:"DetailPage",component:dA,props:!0}],pA=P0({history:r0("/Intellectuals-Artificial-Criminals/"),routes:hA});A_(C_).use(pA).mount("#app");
